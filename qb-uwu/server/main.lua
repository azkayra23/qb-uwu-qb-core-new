...
QBCore.Functions.CreateCallback('qb-uwu:server:get:ingredientPancake', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
    local milk_pack = Ply.Functions.GetItemByName("milk_pack")
    ...
    if milk_pack ~= nil and flour ~= nil and egg ~= nil and cheese ~= nil then
        cb(true)
    else
        cb(false)
    end
...
QBCore.Functions.CreateCallback('qb-uwu:server:get:ingredientCupcake', function(source, cb)
    ...
    local flour = Ply.Functions.GetItemByName("flour")
    local milk_pack = Ply.Functions.GetItemByName("milk_pack")
    if rawsugar ~= nil and egg ~= nil and flour ~= nil and milk_pack ~= nil then
        cb(true)
    else
        cb(false)
    end
...
QBCore.Functions.CreateCallback('qb-uwu:server:get:ingredientvSandwich', function(source, cb)
    ...
    if rawsugar ~= nil and egg ~= nil and flour ~= nil and milk_pack ~= nil and vanillabean ~= nil then
        cb(true)
    else
        cb(false)
    end
...
QBCore.Functions.CreateCallback('qb-uwu:server:get:ingredientcSandwich', function(source, cb)
    ...
    if rawsugar ~= nil and egg ~= nil and flour ~= nil and milk_pack ~= nil and chocolate ~= nil then
        cb(true)
    else
        cb(false)
    end
